...
-- Lots
INSERT INTO lot(title, cat_id, start_price, img_path, rate_step, author_id, winner_id, end_date) VALUES('2014 Rossignol District Snowboard', 1, 10999, 'img/lot-1.jpg', 100, 1, 2, '2019-02-19');
INSERT INTO lot(title, cat_id, start_price, img_path, rate_step, author_id, winner_id, end_date) VALUES('DC Ply Mens 2016/2017 Snowboard', 1, 159999, 'img/lot-2.jpg', 100,  2, 3, '2019-02-20');
INSERT INTO lot(title, cat_id, start_price, img_path, rate_step, author_id, winner_id, end_date) VALUES('Крепления Union Contact Pro 2015 года размер L/XL', 2, 8000, 'img/lot-3.jpg', 100,  3, 1, '2019-02-22');
...
INSERT INTO lot(title, cat_id, start_price, img_path, rate_step, author_id, winner_id, end_date) VALUES('Куртка для сноуборда DC Mutiny Charocal', 4, 7500, 'img/lot-5.jpg', 100,  2, 3, '2019-02-17');
